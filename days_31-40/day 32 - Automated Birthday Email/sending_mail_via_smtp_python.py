...
at yahoo it works simiarly to google smtp server
"""
...
send_email = input("Do you want to send an email? (y/n): ")
if send_email == "y":
    ...
    with smtplib.SMTP_SSL("smtp.gmail.com", port=465, context=ssl_context) as smtp_connection:  # start smpt
        # because of with statement, smtp_connection is automatically closed at the end - like with open file with
        # "smtp.gmail.com" <- have to check this in google - google what smtp gmail has
